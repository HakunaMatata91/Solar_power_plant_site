...
function initSliders() {
	...
	if (document.querySelector('.slider-info__slider')) { // Указываем скласс нужного слайдера
		// Создаем слайдер
		new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.slider-info__slider', { // Указываем скласс нужного слайдера

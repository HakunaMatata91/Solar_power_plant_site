...
function initSliders() {
	...
	if (document.querySelector('.ext-content__slider-body')) { // Указываем скласс нужного слайдера
		// Создаем слайдер
		new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.ext-content__slider-body', { // Указываем скласс нужного слайдера

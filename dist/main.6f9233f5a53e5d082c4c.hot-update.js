...
function initSliders() {
	...
	if (document.querySelector('.text-content__slide')) { // Указываем скласс нужного слайдера
		// Создаем слайдер
		new swiper__WEBPACK_IMPORTED_MODULE_0__["default"]('.text-content__slide', { // Указываем скласс нужного слайдера
